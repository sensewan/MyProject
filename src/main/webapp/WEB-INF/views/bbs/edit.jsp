...
<div id="wrap">
	...
	<div id="contents_sub">
		...
		<h1 style="font-size: 30px; color: #000; margin-bottom: 20px;">공헌 편집 하기</h1>
		
		<div class="bbs_area" id="bbs">
			<!--             ↱ ViewController로 가서 @RequestMapping 찾아감 -->
				...
				<table summary="게시판 글쓰기">
					...
					<!-- 	<tr>
						...
						<tr>
					 	...
					 	<tr>
							<th>첨부파일:<c:if test="${bvo.file_name != null }">(${bvo.file_name })</c:if></th>
